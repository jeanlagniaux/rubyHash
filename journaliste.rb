...
puts "il y a = '#{getAude(array)}'  journaliste avec 'aude' dans leur nom dans la liste"
...
puts "il y a = '#{getMaj(array)}'  journaliste avec une Maj dans leur nom dans la liste"
...
puts "il y a = '#{getMin(array)}'  journaliste avec une Min dans leur nom dans la liste"
...
puts "il y a = '#{getUnder(array)}'  journaliste avec un underscore dans leur nom dans la liste"

def arraySortAlpha(array)
    return array.sort
  end

puts "#{arraySortAlpha(array)}"

def arraySortShortest(array)
    arr = Array.new
    arr = array.sort_by(&:length)
	return arr[0..49]
  end

puts "#{arraySortShortest(array)}"

def arrayWhereIsEpenser(array, nom)
    arr = Array.new
    arr = array.index(nom)
    return arr
  end
